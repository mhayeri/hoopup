...
const inputClass =
  'mt-1 w-full rounded-lg border border-[var(--color-ink)]/20 bg-white px-3 py-2 outline-none focus:border-red-600 focus:ring-2 focus:ring-red-600/20';
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <label className="block">
        <span className="text-xs font-semibold uppercase tracking-widest text-[var(--color-hardwood)]">
          Type <span className="text-red-700">{username}</span> to confirm
        </span>
        <input
          type="text"
          required
      ...
      <button
        ...
        className="rounded-full bg-red-600 px-6 py-2 font-semibold text-white shadow-md shadow-red-600/30 transition hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-60"
      >
