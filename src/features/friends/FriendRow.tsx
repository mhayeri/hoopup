      ...
      >
        {variant === 'incoming' ? (
          <>
            <button
              ...
              className="flex-1 sm:flex-none rounded-full bg-[var(--color-volt)] px-3 py-2 sm:py-1.5 text-xs font-semibold text-[var(--on-volt)] transition hover:bg-[var(--color-volt)]/90 disabled:opacity-60"
            >
              Accept
            </button>
            <button
              ...
              className="flex-1 sm:flex-none rounded-full border border-[var(--border-strong)] px-3 py-2 sm:py-1.5 text-xs font-semibold text-[var(--color-bone)]/70 transition hover:bg-[var(--hover)] disabled:opacity-60"
            >
              Decline
            </button>
          </>
        ...
        {variant === 'outgoing' ? (
          <button
            ...
            className="rounded-full border border-[var(--border-strong)] px-3 py-1.5 text-xs font-semibold text-[var(--color-bone)]/70 transition hover:bg-[var(--hover)] disabled:opacity-60"
          >
            Cancel
          </button>
        ) : null}
        {variant === 'accepted' ? (
          <button
            ...
            className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-[var(--border)] text-[var(--color-bone)]/55 transition hover:border-red-500/40 hover:bg-red-500/10 hover:text-red-300 disabled:opacity-60"
          >
